...
class FansHubService
{
    ...
    public static function h5CopyFieldGroups()
    {
        return [
            ...
            '钱包提示' => [
                ...
                'wallet_ledger_type_niuniu_buy' => '流水类型-牛牛购入',
                'wallet_ledger_type_niuniu_packet' => '流水类型-牛牛红包',
            ...
            '多语言与区号' => [
                ...
                'login_phone_placeholder_ae'  => '阿联酋手机号占位',
                'login_phone_placeholder_tr'  => '土耳其手机号占位',
                'login_phone_placeholder_ru'  => '俄罗斯手机号占位',
                'login_phone_placeholder_jp'  => '日本手机号占位',
    ...
    public static function publicConfig()
    {
        ...
        return [
            ...
            'login_brand_logo_url' => (function () use ($cfg) {
                $raw = trim((string)($cfg['login_brand_logo_url'] ?? ''));
                if ($raw === '') {
                    return '';
                }
                if (class_exists('\\app\\common\\library\\OssService')) {
