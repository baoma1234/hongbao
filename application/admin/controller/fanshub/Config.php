...
class Config extends Backend
{
    ...
    protected $sectionFields = [
        'basic' => [
            ...
            'app_update_enabled',
            'app_android_version_name', 'app_android_version_code', 'app_android_download_url',
            'app_android_force_update', 'app_android_update_note',
            ...
            'brand_logo_url', 'login_brand_logo_url',
            ...
            'lobby_live_enabled', 'lobby_live_test_token',
        ...
        'security' => [
            ...
            'multi_login_user_ids', 'auto_accept_friend_user_ids', 'fund_bypass_user_ids', 'notice_auto_approve_user_ids',
        ],
        'telegram' => [
