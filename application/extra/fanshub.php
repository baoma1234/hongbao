...
return array (
  ...
  'market_daily_grow_min' => 0,
  'market_daily_grow_max' => 0,
  ...
  'exchange_rh_enabled' => false,
  'exchange_hr_enabled' => false,
  ...
  // 顶部品牌 Logo（TopBar / 方标）；空则用打包 static/logo.png
  'brand_logo_url' => '',
  // 登录页横标（login-brand-logo）；空则用 static/login/logo-l.png
  'login_brand_logo_url' => '',
...
如您在使用过程中需要任何帮助，请随时联系我，我会及时为您解答与处理。',
  ...
  'group_77_sender_nickname' => '红宝吃瓜社',
  ...
  'og_api_base_url' => 'http://xyz.pwqr820.com:9003',
  'og_sandbox_base_url' => 'http://xyz.pwqr820.com:9003',
  'og_currency' => 'CNY',
  'og_language' => 'zh',
...
邀请链接',
  'marquee_text' => '❤️ 欢迎来到【红宝】直营站 ❤️  【红宝全球首创 · 多元体验】 🔥 福利专群｜推广赚钱 📰 新闻资讯｜白嫖曝光 ✨ 更多精彩栏目持续上线  一站汇聚多元内容，打造属于红宝的全新体验！  🌐 易记网址：qhb.app 🔴 【红宝唯一指定官网】',
...
🔥火热开启领取888,888元',
    ...
    'page_hero_claim_title' => '红宝合作商555.bio赞助VIP特批领取',
    'page_hero_claim_sub' => '填写该游戏站注册的账号->提交核销->即可自动到账2股',
    ...
    'chat_rp_robot_only' => '本群仅自动机器人可发红包',
    ...
    'profile_pay_password_title' => '支付密码',
    ...
    'profile_withdraw_avail_prefix' => '可提现金额：',
    'profile_turnover_prefix' => '出款所需流水为：',
    ...
    'wallet_ledger_type_recharge_pending' => '充值中',
    ...
    'wallet_ledger_type_red_packet_agent_rebate' => '红宝返佣支出',
    ...
    'wallet_ledger_empty_freeze' => '暂无冻结记录',
    'wallet_ledger_cat_rebate' => '红宝返佣',
    'wallet_ledger_empty_rebate' => '暂无红宝返佣流水',
    ...
    'wallet_turnover_need' => '出款所需流水为：{need}',
    'wallet_turnover_ratio_suffix' => '',
    'wallet_turnover_line' => '出款所需流水为：{amount}',
    'wallet_turnover_ok' => '出款所需流水为：0，可申请提现',
    'wallet_loading' => '加载中…',
    ...
    'chat_commission_rebate' => '红宝返佣',
    'chat_commission_nav_promo' => '推广结算',
    'chat_commission_nav_rebate' => '红宝返佣',
    ...
    'chat_rp_type_lucky_desc' => '拼手气玩法，类似接龙模式一点不同在于，发包同时自己也可以进行领取，例如：金额100包数5 自己也可以进行参与领包，自己若是领取20.98，剩余金额其他用户进行领取，领取最少金额的用户需赔该包金额100遇到多人领取最少同样金额采用领取最少领取时间最晚将赔付该包金额，若是自己发包抢包领取最少则不进行赔付扣款',
    ...
    'chat_commission_empty_rebate' => '暂无红宝返佣记录',
  ...
  'jackpot_server_sync' => false,
  // 股份大盘/送股/股价重算总开关：关闭后不再 SUM 流水、不跑日增长、前端不轮询 jackpot
  'rights_market_enabled' => false,
