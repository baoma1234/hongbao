define(['jquery', 'bootstrap', 'backend', 'form'], function ($, undefined, Backend, Form) {
    var fieldSectionMap = {
        ...
        app_update_enabled: 'basic',
        app_android_version_name: 'basic',
        app_android_version_code: 'basic',
        app_android_download_url: 'basic',
        app_android_force_update: 'basic',
        app_android_update_note: 'basic',
        app_ios_version_name: 'basic',
        app_ios_version_code: 'basic',
        app_ios_download_url: 'basic',
        app_ios_force_update: 'basic',
        app_ios_update_note: 'basic',
